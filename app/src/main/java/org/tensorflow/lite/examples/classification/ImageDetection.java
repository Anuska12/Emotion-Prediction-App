...
public class ImageDetection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buclassify=(Button)findViewById(R.id.btn);
        classitext=(TextView)findViewById(R.id.txtview);
    ...
    private MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("dmodel.tflite");
